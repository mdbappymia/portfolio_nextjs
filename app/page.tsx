...
const Home = () => {
  return (
    <div className="lg:grid lg:grid-cols-4 w-full lg:gap-3">
      <div className="col-span-3">
        <div className="grid lg:grid-cols-3  gap-3">
          ...
          <div className="lg:col-span-2">
            <div className="md:grid grid-cols-2 block gap-3 mb-3">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 lg:gap-3 my-3">
      ...
      <div className="m">
        <RightMirquee />
        <div className="md:grid lg:block lg:grid-cols-2 grid-cols-1 md:gap-3 my-5">
          <RightShotInfo />
          <RightLatestWork />
        </div>
      </div>
